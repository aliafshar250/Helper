...
function show_supergroup_settingsmod(msg, target)
  ...
  local text = "\n*SuperGroup settings:*\n*____________________*\n*Lock links : *"_settings.lock_link_"\n*Lock contacts: *"_settings.lock_contacts_"\n*Lock flood: *"_settings.flood_"\n*️Flood sensitivity : *"_NUM_MSG_MAX_"\n*Lock spam: *"_settings.lock_spam_"\n*Lock Arabic: *"_settings.lock_arabic_"\n*️Lock Member: *"_settings.lock_member_"\n*️Lock RTL: *"_settings.lock_rtl_"\n*️Lock Tgservice: *"_settings.lock_tgservice_"\n*️Lock sticker: *"_settings.lock_sticker_"\n*️Lock tag: *"_settings.tag_"\n*️Lock emoji: *"_settings.emoji_"\n*️Lock english: *"_settings.english_"\n*️Lock Forward: *"_settings.fwd_"\n*️Lock reply: *"_settings.reply_"\n*️Lock join: *"_settings.join_"\n*️Lock username: *"_settings.username_"\n*️Lock media: *"_settings.media_"\n*️Lock fosh: *"_settings.fosh_"\n*️Lock leave: *"_settings.leave_"\n*️Lock bots: *"_bots_protection_"\n*️Lock operator: *"_settings.operator_"\n____________________\n*Easy Sweet&Faster Switch*:️\n____________________\n*Switch Model Etehad: *"_settings.etehad_"\n*️Lock all: *"_settings.all_"\n*____________________*\n*ℹ️About Groupℹ️:*️\n____________________\n*️Group type: *"_gp_type_"\n*️Public: *"_settings.public_"\n*️Strict settings: *"_settings.strict_"\n*____________________*\n*💥Bot Version : 1.0 💥*\n_💥Sinal Bot💥_\n[SignalTM](https://telegram.me/SignalTM)"
  return text
end
